...
package Tiny_Model is
   ...
   type Weight_Format is
     (F32, F16, BF16, Q4_0, Q4_1, Q5_0, Q5_1, Q8_0,
      Q2_K, Q3_K, Q4_K, Q5_K, Q6_K, IQ4_NL, IQ4_XS, IQ3_S, MXFP4);
   ...
   is (case Shape is
         when Mixed => Kind in Falcon | Phi2 | GPT2 | Bert | Starcoder2
                              | Stablelm | Gptneox | Mpt | Mamba,
         when Stretched => Kind in GPT2 | Bert | Jina_Bert_V2 | Mpt | Mamba,
         when Windowed => Kind in Bert | Nomic_Bert | Jina_Bert_V2 | Mamba,
         when Apart => Kind in Qwen35 | Mamba,
         when Reaching =>
