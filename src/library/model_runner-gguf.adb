package body Model_Runner.GGUF is
   ...
   Formats : constant array (Tensor_Type) of Format_Info :=
     [Type_F32     => (0,  1,            4,   True),
      ...
      Type_Q4_1    => (3,  Legacy_Block, 20,  True),
      Type_Q5_0    => (6,  Legacy_Block, 22,  True),
      Type_Q5_1    => (7,  Legacy_Block, 24,  True),
      ...
      Type_IQ2_XS  => (17, Super_Block,  74,  True),
      Type_IQ2_S   => (22, Super_Block,  82,  True),
      Type_IQ3_XXS => (18, Super_Block,  98,  True),
   ...
   begin
      case Item is
         ...
         when Type_IQ2_XS  => return "IQ2_XS";
         when Type_IQ2_S   => return "IQ2_S";
