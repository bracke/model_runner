...
conformance: sequences 27844, logits compared 857184,
             ...
             worst relative 4.48754376584344E-02,
             ...
             cached worst relative 1.99020965899255E+00,
             byte logits compared 52640,
             byte worst absolute 3.02788895569006E-01,
             byte worst relative 1.98096722512354E+00,
             outside tolerance 0, unlearned 0
```

The run above crossed 12 architectures, in 15 formats and 5 shapes, of which
1152 ran on a device -- which is the same claim the paragraph below makes in
words, and is checked against the run rather than kept by hand.

Twelve architectures -- `llama`, `qwen2`, `qwen3`, `gemma`, `gemma2`, `gemma3`, `phi3`, `falcon`, `phi2`,
`gpt2`, `bert` and `nomic-bert`, each of which has also been read from a file somebody else published -- in each of the five shapes a supported model comes in: dense, sliding-window, a mixture of
