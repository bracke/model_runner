...
```
conformance: sequences 19005, logits compared 262080,
...
Seven architectures -- `llama`, `qwen2`, `qwen3`, `gemma`, `gemma2`, `gemma3` and `phi3` -- in each of the five
