...
```
conformance: sequences 13575, logits compared 187200,
...
Five architectures -- `llama`, `qwen2`, `qwen3`, `gemma` and `gemma2` -- in each of the five
