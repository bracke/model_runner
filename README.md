...
```
conformance: sequences 16290, logits compared 224640,
...
Six architectures -- `llama`, `qwen2`, `qwen3`, `gemma`, `gemma2` and `gemma3` -- in each of the five
