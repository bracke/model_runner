...
| Localization | Every application-authored string through `messages`; 149 diagnostic codes each with a catalog entry; English, a partial Danish translation that inherits per key, and a generated pseudo-locale; locale precedence with an emergency path that cannot recurse |
