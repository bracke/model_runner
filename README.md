...
```
conformance: sequences 21270, logits compared 292320,
             worst absolute 6.61448463254999E-05,
             worst relative 1.04214844164070E-02,
             rounded logits compared 28800,
             rounded worst absolute 1.36861269753309E-01,
             rounded worst relative 1.83560177726357E+00,
             cached logits compared 19200,
             cached worst absolute 5.38178472786255E-02,
             cached worst relative 7.52813416791468E-01,
             outside tolerance 0
```

Eight architectures -- `llama`, `qwen2`, `qwen3`, `gemma`, `gemma2`, `gemma3`, `phi3` and `falcon` -- in each of
the five shapes a supported model comes in: dense, sliding-window, a mixture of
